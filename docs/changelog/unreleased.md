...
- Pin the prompt Table of Contents beside terminal and chat content, browse clearer numbered prompt rows with roomier pinned previews, then resize the split from its edge-aligned subtle divider without covering the conversation.
