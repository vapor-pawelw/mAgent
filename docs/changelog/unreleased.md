...
- Extended the sidebar beneath the standard macOS controls with one seamless blur through sticky headers, letting scrolling content blur naturally behind them while keeping resting content clear, without moving the tab bar, and aligned the top current-thread strip to the content area.
