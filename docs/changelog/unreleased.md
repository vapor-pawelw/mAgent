...
- Pin the prompt Table of Contents beside terminal and chat content, browse high-contrast numbered rows with a clear Latest marker and roomier pinned previews, then resize the split from its edge-aligned subtle divider without covering the conversation.
