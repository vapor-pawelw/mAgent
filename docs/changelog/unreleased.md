...
- Jira ticket statuses shown on thread rows now refresh during regular status syncs and immediately after agent completion instead of waiting for cached ticket data to expire.
