...
- `SplitViewController` overrides of `NSSplitViewDelegate` methods must call `super` so AppKit's controller-specific divider constraints run before Magent's width policy.
