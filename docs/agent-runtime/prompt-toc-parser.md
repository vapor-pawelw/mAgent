...
- Cached prompts that no longer occur in the complete tmux scrollback remain available for copy and rename, but show `Outside terminal history` and do not offer jump navigation.
