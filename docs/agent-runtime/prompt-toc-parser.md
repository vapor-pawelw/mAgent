...
- Cached prompts that no longer occur in the complete tmux scrollback remain available for copy and rename. Their text is subtly dimmed, persisted timing remains visible, and selecting one shows a short informational banner explaining that Magent can no longer scroll to it.
