...
- Every Codex app-server turn explicitly reapplies the current Agent Permissions mode. This prevents a resumed conversation's older sandbox/approval policy from overriding Full Access or Sandbox Auto selected in Settings.
