...
- The composer uses one adaptive rounded surface with borderless attachment/send controls; multiline growth keeps those controls aligned to the bottom edge.
