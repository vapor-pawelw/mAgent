...
actor IPCSocketServer {
    ...
    nonisolated private static func installCLIScript() {
        ...
        --force archives anyway. For dirty worktrees it first auto-commits tracked/untracked changes with a generic commit message, then archives. Ignored files are still deleted. Suggested: commit first yourself for a more meaningful message."
        ...
        ""|help|-h|--help)
            ...
            echo "  archive-thread       --thread <name> [--force] [--skip-local-sync]  (removes worktree, keeps branch; refused for dirty or notable ignored files unless --force; dirty --force auto-commits first)"
