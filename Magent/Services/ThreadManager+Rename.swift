...
extension ThreadManager {
    ...
    func generateAutomaticTabName(prompt: String, preferredAgent: AgentType, projectId: UUID) async -> String? {
        await renameService.generateAutomaticTabName(
            prompt: prompt,
            preferredAgent: preferredAgent,
            projectId: projectId
        )
    ...
    func generateTabNameFromMessage(_ message: String, preferredAgent: AgentType, projectId: UUID) async -> String? {
        await renameService.generateTabNameFromMessage(
            message,
            preferredAgent: preferredAgent,
            projectId: projectId
        )
