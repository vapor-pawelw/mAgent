...
enum ThreadManagerError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .dirtyWorktree(let worktreePath):
            let message = "Worktree has uncommitted or untracked changes at \(worktreePath). Archiving will remove the worktree directory and abandon this work. Commit or stash first, or pass --force (CLI) / confirm the destructive archive prompt (GUI) to proceed anyway."
            return message
