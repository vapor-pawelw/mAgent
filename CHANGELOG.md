...
- Inline thread badges now support right-click actions to mark threads done, clear completed work, remove favorites, or archive completed threads, while status glyphs keep the collapsed status item click and context-menu behavior.
