...
### Sidebar
- The base branch label in the changes panel is now clickable — opens a menu of ancestor branches (closest-first) to quickly change the base branch for diff comparison.
